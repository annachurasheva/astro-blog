...
(window => {
    ...
    const deprecatedWindowMembers = new Set(["sharedStorage", "SharedStorage", "AttributionReporting", "attributionReporting", "AttributionReportingRequestOptions", "attributionSrc", "setAttributionReporting"]);
    const isValidMemberName = memberName => !(startsWith(memberName, "webkit") || startsWith(memberName, "toJSON") || startsWith(memberName, "constructor") || startsWith(memberName, "toString") || startsWith(memberName, "_") || deprecatedWindowMembers.has(memberName));
